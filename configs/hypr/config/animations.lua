...
hl.curve("rubber",         { type = "spring", mass = 1, stiffness = 500,      dampening = 41         })
...
hl.animation({ leaf = "specialWorkspaceIn",  enabled = true, speed = 6, bezier = "easeOutQuint", style = "slide top"})
hl.animation({ leaf = "specialWorkspaceOut", enabled = true, speed = 6, bezier = "easeOutQuint", style = "slide bottom"})
